...
function update_expertise() {
	...
	if ($('.expertise_bar_outer').length == 0) {
		$('.sell_value').after('<div class="expertise_bar_outer tooltip" x-type="expertise"><div class="expertise_bar_inner" style="width: ' + remaining + '%;"></div><div class="expertise_hover">' + (sold-last_sale) + '/' + parseInt(sales_needed-last_sale) + '</div><div class="expertise_number">Expertise level ' + expertise + '</div></div>');
	} else {
		$('.expertise_bar_inner').css('width', remaining + '%');
		$('.expertise_number').text('Expertise level ' + expertise);
