...
var ics = angular.module('ics', []);
	...
	ics.controller('highscores', ["$scope", function ($scope) {
	}])
	.controller('flavourController', ["$scope", "upgradesService", "flavourService", "$interval", function ($scope, upgradesService, flavourService, $interval) {
	...
	.controller('quests', ["$scope", function ($scope) {
	}])
	.controller('events', ["$scope", function ($scope) {
	}])
	.controller('trends', ["$scope", function ($scope) {
	}])
	...
	.controller('money', ["$scope", "$interval", function ($scope, $interval) {
	...
	.controller('upgrades', ["$scope", "upgradesService", function ($scope, upgradesService) {
		$scope.addons_locked;
	...
	ics.factory('upgradesService', ["$http", function($http) {
	    return {
	    	flavours_unlocked: [],
	    	addons_unlocked: [],
	...
	.factory('flavourService', ["$http", function($http) {
	   return {
	        get_combos: function() {
	            //return the promise directly.
	...
	.filter('chat_sanitize', ["$sce", function($sce) {
	    return function(input) {
