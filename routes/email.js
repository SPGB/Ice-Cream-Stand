module.exports = (function() {
	...
	function send_email(msg, subject, to, cta) {
		if (!to.email) {
		...
		mailcomposer.setMessageOption({
			...
			'<h1>' + subject + '</h1>' + msg + '<center><a href="http://icecreamstand.ca" style="background-color: #0da673; box-shadow: 0 2px 0 #097752; color: #fff; border-radius: 4px; padding: 10px; margin: 10px auto; text-align: center; text-decoration: none; font-size: 20px;">' + cta + '</a></center>' +
